...
const DivcnHpMediaWrapper: FunctionComponent<DivcnHpMediaWrapperType> = ({
  className = "",
}) => {
  return (
    <div
      className={`self-stretch flex flex-row flex-wrap items-start justify-between pt-14 px-0 pb-[55px] gap-[20px] border-t-[0.6px] border-solid border-silver-100 border-b-[0.6px] mq1600:justify-center ${className}`}
    >
...
export default DivcnHpMediaWrapper;
