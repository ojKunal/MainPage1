...
const FrameComponent5: FunctionComponent<FrameComponent5Type> = ({
  ...
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-[33.8px] box-border max-w-full shrink-0 text-left text-25xl text-whitesmoke-100 font-poppins ${className}`}
    >
      <div className="h-[900px] flex-1 bg-gray-300 flex flex-col items-start justify-start pt-[324.7px] px-0 pb-4 box-border relative gap-[9.2px] max-w-full mq450:h-auto mq450:pt-[38px] mq450:box-border mq900:pt-[58px] mq900:box-border mq1275:pt-[89px] mq1275:pb-5 mq1275:box-border">
        ...
        <div className="self-stretch flex flex-row items-start justify-center pt-0 px-5 pb-[176.9px] box-border max-w-full text-base text-gray-300 font-inter">
          <div className="h-16 rounded-18xl bg-white overflow-x-auto flex flex-row items-start justify-start py-3 pr-0 pl-[25px] box-border gap-[10px] max-w-full z-[1]">
            <div className="w-[302px] box-border shrink-0 flex flex-row items-start justify-start py-px pr-2.5 pl-0 text-gray-200 border-r-[0.6px] border-solid border-whitesmoke-300">
            ...
            <div className="w-[232px] shrink-0 flex flex-col items-start justify-start py-0 pr-[37px] pl-0 box-border relative">
              <div className="self-stretch flex flex-row items-start justify-start pt-[8.6px] px-0 pb-[11.5px] gap-[16.9px] border-r-[0.6px] border-solid border-whitesmoke-300">
              ...
              <img
                className="w-5 h-5 absolute !m-[0] top-[calc(50%_-_10px)] right-[7px] overflow-hidden shrink-0"
                alt=""
                src="/frame-2.svg"
              />
            </div>
            <div className="w-[243px] shrink-0 flex flex-col items-end justify-start gap-[23px]">
              ...
              <button className="cursor-pointer [border:none] pt-2.5 pb-[7.4px] pr-2.5 pl-[11px] bg-white h-8 rounded-81xl flex flex-row items-end justify-start box-border gap-[15px]">
                ...
                <div className="flex flex-row items-start justify-start gap-[3.3px]">
                  <div className="flex flex-col items-start justify-start pt-[7.6px] px-0 pb-0">
                    <div className="relative text-xs tracking-[0.12px] leading-[18px] font-semibold font-inter text-gray-300 text-left inline-block min-w-[94px]">
                      Advanced Filter
                    </div>
                  </div>
                  <div className="h-px w-px relative rounded-3xs bg-hotpink" />
                </div>
              </button>
            </div>
          </div>
        </div>
        <div className="w-[621px] flex flex-row items-start justify-center pt-0 px-5 pb-[5371.7px] box-border max-w-full text-lg text-black font-inter mq900:pb-[959px] mq900:box-border mq1275:pb-[1475px] mq1275:box-border">
                ...
                <div className="self-stretch flex flex-row items-start justify-start gap-[4px]">
                  ...
                  <div className="flex-1 flex flex-col items-start justify-start pt-px px-0 pb-0">
                    <div className="self-stretch flex flex-row items-end justify-start gap-[21px]">
                      <div className="h-[22px] flex-1 overflow-hidden flex flex-row items-start justify-start py-0 pr-[15px] pl-0 box-border">
                        <div className="mt-[-1.7px] flex-1 relative tracking-[-0.36px] leading-[47px] font-semibold whitespace-nowrap">
