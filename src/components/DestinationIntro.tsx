...
const DestinationIntro: FunctionComponent<DestinationIntroType> = ({
  className = "",
  ...
  return (
    <div
      className={`self-stretch flex flex-col items-start justify-start gap-[13.3px] max-w-full text-left text-13xl text-gray-300 font-inter ${className}`}
      style={destinationIntroStyle}
    >
      <h1 className="m-0 relative text-inherit leading-[39px] font-semibold font-inherit inline-block max-w-full mq450:text-lgi mq450:leading-[23px] mq900:text-7xl mq900:leading-[31px]">
        {trendingDestinations}
      </h1>
