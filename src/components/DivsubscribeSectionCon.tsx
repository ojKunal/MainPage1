...
const DivsubscribeSectionCon: FunctionComponent<DivsubscribeSectionConType> = ({
  className = "",
}) => {
  return (
    <div
    ...
    >
      ...
      <form className="m-0 w-[411.7px] flex flex-row items-start justify-start gap-[10px] max-w-full mq450:flex-wrap">
        <div className="flex-1 flex flex-col items-start justify-start gap-[15px] min-w-[181px]">
          <input
            className="w-full [border:none] [outline:none] bg-white self-stretch h-[38px] rounded-md overflow-hidden shrink-0 flex flex-row items-start justify-start pt-0 px-5 pb-[18px] box-border font-poppins text-base text-gray-200 min-w-[167px]"
...
export default DivsubscribeSectionCon;
