...
const Httpswwwcuddlynestcom: FunctionComponent = () => {
  return (
    <div className="w-full relative bg-whitesmoke-100 flex flex-row items-start justify-start py-0 px-0 box-border leading-[normal] tracking-[normal]">
      <main className="h-[9629.1px] flex-1 bg-white flex flex-col items-start justify-start pt-0 px-0 pb-[2615.4px] box-border gap-[1.8px] shrink-0 max-w-full mq450:h-auto mq900:pb-[304px] mq900:box-border mq1275:pb-[467px] mq1275:box-border">
        <FrameComponent5 />
        <FrameComponent3 />
        <Destination />
        <AdvancedFilterLabel />
...
export default Httpswwwcuddlynestcom;
